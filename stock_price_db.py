...
def add_techincal_indicators(data):
...
for indicator in indicators:
    if indicator == 'SMA 20':
        ...
        fig.add_trace(go.Scatter(x=data['Datetime'], y=data['SMA_20'], name='EMA 20'))
...
st.sidebar.info('This Dashboard was developed by Deep Charts (www.youtube.com/@DeepCharts) and modified by Carlos Ojeda')        